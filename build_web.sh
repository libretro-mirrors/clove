 emcc  src/3rdparty/slre/slre.c
 src/3rdparty/stb/stb_image.c src/3rdparty/stb/stb_vorbis.c
 ...
 src/3rdparty/lua/ltable.c src/3rdparty/lua/ltm.c src/3rdparty/lua/lua.c
 src/3rdparty/lua/luac.c src/3rdparty/lua/lvm.c src/3rdparty/lua/lzio.c
 src/3rdparty/lua/print.c  src/main.cpp src/mouse.c src/mainactivity.c
 ...
 src/tools/utf8.c src/tools/utils.c -s USE_SDL=2 -s FULL_ES2=1 -O1 -Wall
 --memory-init-file 0 -DFT2_BUILD_LIBRARY -Wall -I src/3rdparty/lua/ -I
 src/3rdparty/openal/include/ -I src/tools/ -I src/3rdparty/freetype/src/ -I
 src/3rdparty/glew/include/GL -I src/3rdparty/CMath -I src/3rdparty/microtar -I
 src/3rdparty/noise -I src/3rdparty/freetype/include/ -I src/include/ -O1
 -o clove.html
